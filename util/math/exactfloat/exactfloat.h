...
class ExactFloat {
 public:
  ...
  explicit ExactFloat(const char* ) { Unimplemented(); }
  ...
  friend ExactFloat fmod(const ExactFloat& , const ExactFloat& ) {
  ...
  // (a - rint(a / b) * b).
  friend ExactFloat remainder(const ExactFloat& , const ExactFloat& ) {
    // Note that it is possible to implement this operation exactly, it just
    // hasn't been done.
    return Unimplemented();
  }
  ...
  friend ExactFloat modf(const ExactFloat& , ExactFloat* ) {
    // Note that it is possible to implement this operation exactly, it just
    // hasn't been done.
    return Unimplemented();
  }
