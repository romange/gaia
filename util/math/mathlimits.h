...
#define DECL_INT_LIMIT_FUNCS \
  static bool IsFinite(const Type ) { return true; } \
  static bool IsNaN(const Type ) { return false; } \
  static bool IsInf(const Type ) { return false; } \
  static bool IsPosInf(const Type ) { return false; } \
  static bool IsNegInf(const Type ) { return false; }
...
// ========================================================================= //
#ifdef WIN32  // Lacks built-in isnan() and std::isinf()
