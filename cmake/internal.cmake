...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fno-omit-frame-pointer -Wno-unused-parameter -Wno-implicit-fallthrough")
...
function(cxx_test name)
  ...
  cxx_link(${name} gtest_main fast_malloc ${parsed_UNPARSED_ARGUMENTS})
