...
public class WordCount {
  ...
  static class ExtractWordsFn extends DoFn<String, String> {
    ...
    private final Counter invalid = Metrics.counter(ExtractWordsFn.class, "invalidLine");
    private final Counter invalidWord = Metrics.counter(ExtractWordsFn.class, "invalidWord");
    ...
    public void processElement(@Element String element, OutputReceiver<String> receiver) {
      ...
      try {
        Utf8.encodedLength(element);
      } catch(IllegalArgumentException e) {
        LOG.error("Invalid line " + element);
        invalid.inc();
        return;
      }
      ...
      for (String word : words) {
        if (!word.isEmpty()) {  
          try {
            ...
            LOG.error("Invalid word " + word + " for line " + element);
            invalidWord.inc();
            continue;
          }
